...
import Welcome from './../components/default/welcome.vue'
import Picture from './../components/default/picture.vue'
...
export default new VueRouter({
  ...
  routes: [{
    ...
    children: [
      ...
      { path: '/picture', component: Picture, name: '轮播图管理' },
    ]
  }, {
    path: '/',
    component: Home,
    ...
    children: [
      ...
      { path: '/press', component: Press, name: '出版社管理' }
    ]
  }, {
    path: '/',
    component: Home,
